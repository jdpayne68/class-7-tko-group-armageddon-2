...
SOAR_NOTIFICATIONS_TOPIC_ARN = os.environ["SOAR_NOTIFICATIONS_TOPIC_ARN"]
CRITICAL_ALERTS_TOPIC_ARN = os.environ["CRITICAL_ALERTS_TOPIC_ARN"]
...
def publish_notification(
    ...
    topic_arn = (
        os.environ["CRITICAL_ALERTS_TOPIC_ARN"]
        if playbook["severity"] == "CRITICAL"
        else os.environ["SOAR_NOTIFICATIONS_TOPIC_ARN"]
        )
