...
module "dynamodb" {
  ...
  compliance_evidence_table_name = "${local.prefix}-compliance-evidence"
...
module "iam" {
  ...
  compliance_evidence_table_arn = module.dynamodb.compliance_evidence_table_arn
  # compliance_evidence_table_arn = module.dynamodb.compliance_evidence_table_arn
...
module "lambdas" {
  ...
  compliance_evidence_table_name = module.dynamodb.compliance_evidence_table_name
