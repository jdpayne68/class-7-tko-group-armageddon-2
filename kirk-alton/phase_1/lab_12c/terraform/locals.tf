...
locals {
  ...
  compliance_agent_function_name            = "${local.name_prefix}-compliance-agent-${local.name_suffix}"
  ...
  compliance_evidence_table_name    = "${local.name_prefix}-compliance-evidence-${local.name_suffix}"
