...
# -------------------------------------------------------------------------------
# Lambda Function - WAF Log Processor
# -------------------------------------------------------------------------------
...
data "archive_file" "waf_log_processor" {
  type        = "zip"
  source_file = "${path.module}/lambda-code/waf_log_processor.py"
  output_path = "${path.module}/lambda-code/waf_log_processor.zip"
}
