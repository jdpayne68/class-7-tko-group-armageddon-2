...
def publish_notification(
    ...
    # ================================================================
    # BUILD THE FORMATTED EMAIL MESSAGE HERE
    # ================================================================
    message = f"""
═════════════════════
...
SEVERITY: {severity}
RISK:     {finding.get('risk_score', 0)}/100
PLAYBOOK: {playbook['name']}

SOURCE IP:  {finding.get('primary_source_ip', 'UNKNOWN')}
...
"""
    ...
    response = sns_client.publish(
        ...
        Subject=subject[:100],
        Message=message,  # <-- THE FORMATTED MESSAGE GOES HERE
        MessageAttributes={
            "severity": {
                "DataType": "String",
