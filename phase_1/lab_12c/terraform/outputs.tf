...
output "lambda_function_names" {
  ...
  value = {
    ...
    compliance_agent      = aws_lambda_function.compliance_agent.function_name
  }
}
...
output "dynamodb_table_names" {
  ...
  value = {
    ...
    compliance_evidence    = aws_dynamodb_table.compliance_evidence.name
  }
}
...
output "report_bucket_names" {
  description = "S3 buckets used for generated security and compliance reports."
  value = {
    executive_reports           = aws_s3_bucket.executive_report_bucket.id
    compliance_evidence_reports = aws_s3_bucket.compliance_evidence_report_bucket.id
  }
}
...
output "cloudwatch_log_groups" {
  ...
  value = {
    lambda = {
      ...
      compliance_agent      = aws_cloudwatch_log_group.compliance_agent.name
    }
